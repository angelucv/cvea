...
> nb <- knn2nb(nb_knn) 
Warning message:
In knn2nb(nb_knn) : neighbour object has 5 sub-graphs
...
Índice de Moran (Tasa 2016, KNN=2): 0.094 (p-val: 0.02412)
...
+ }
--> CONCLUSIÓN: Existe un patrón espacial claro (P-valor significativo).
