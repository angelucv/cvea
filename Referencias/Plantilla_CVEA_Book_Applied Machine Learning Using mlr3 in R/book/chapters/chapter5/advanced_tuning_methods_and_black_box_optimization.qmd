...
```{r advanced_tuning_methods_and_black_box_optimization-001, error = TRUE, warning = FALSE, message = FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-002}
...
```{r advanced_tuning_methods_and_black_box_optimization-003}
...
```{r advanced_tuning_methods_and_black_box_optimization-004}
...
```{r advanced_tuning_methods_and_black_box_optimization-005}
instance$result
```
...
```{r advanced_tuning_methods_and_black_box_optimization-006}
...
```{r advanced_tuning_methods_and_black_box_optimization-007}
instance = ti(
  task = tsk("sonar"),
  learner = learner,
...
```{r advanced_tuning_methods_and_black_box_optimization-008,output=FALSE}
#| cache: false
...
```{r advanced_tuning_methods_and_black_box_optimization-009}
#| cache: false
...
```{r advanced_tuning_methods_and_black_box_optimization-011}
...
```{r advanced_tuning_methods_and_black_box_optimization-012, message = FALSE, warning = FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-013}
instance = ti(
  task = tsk("sonar"),
  learner = learner,
...
```{r advanced_tuning_methods_and_black_box_optimization-014, message = FALSE}
tuner$optimize(instance)
...
```{r advanced_tuning_methods_and_black_box_optimization-015}
library(bbotk)
...
```{r advanced_tuning_methods_and_black_box_optimization-016}
...
```{r advanced_tuning_methods_and_black_box_optimization-017}
xydt[y == min(y), ]
```
...
```{r advanced_tuning_methods_and_black_box_optimization-018, output=FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-019}
...
```{r advanced_tuning_methods_and_black_box_optimization-020, echo = FALSE, out.width = "80%"}
...
```{r advanced_tuning_methods_and_black_box_optimization-021, echo = FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-022}
...
```{r advanced_tuning_methods_and_black_box_optimization-023}
...
```{r advanced_tuning_methods_and_black_box_optimization-024}
#| cache: false
...
```{r advanced_tuning_methods_and_black_box_optimization-025}
#| cache: false
library(mlr3mbo)
...
```{r advanced_tuning_methods_and_black_box_optimization-026}
#| cache: false
surrogate$update()
...
```{r advanced_tuning_methods_and_black_box_optimization-027}
#| cache: false
...
```{r advanced_tuning_methods_and_black_box_optimization-028}
#| cache: false
...
```{r advanced_tuning_methods_and_black_box_optimization-029}
acq_optimizer = acqo(
...
```{r advanced_tuning_methods_and_black_box_optimization-030}
...
```{r advanced_tuning_methods_and_black_box_optimization-031, eval=FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-032}
...
```{r advanced_tuning_methods_and_black_box_optimization-033}
instance = OptimInstanceSingleCrit$new(objective,
  terminator = trm("evals", n_evals = 20))
design = data.table(x = c(0.1, 0.34, 0.65, 1))
instance$eval_batch(design)
...
```{r advanced_tuning_methods_and_black_box_optimization-034, echo = FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-035, eval=FALSE, echo=FALSE}
library(mlr3misc)
library(pammtools)
set.seed(2906)
...
```{r advanced_tuning_methods_and_black_box_optimization-036, echo=FALSE}
#| echo: false
...
```{r advanced_tuning_methods_and_black_box_optimization-037}
tuner = tnr("mbo",
  loop_function = bayesopt_ego,
  surrogate = surrogate,
  acq_function = acq_function,
...
```{r advanced_tuning_methods_and_black_box_optimization-038}
tuner = tnr("mbo",
...
```{r advanced_tuning_methods_and_black_box_optimization-039, echo = FALSE, warning = FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-040}
...
```{r advanced_tuning_methods_and_black_box_optimization-041, output=FALSE}
...
```{r advanced_tuning_methods_and_black_box_optimization-042, eval = FALSE}
opt("mbo",
  loop_function = bayesopt_ego,
  surrogate = surrogate,
  acq_function = acq_function,
...
```{r advanced_tuning_methods_and_black_box_optimization-043}
